...
declare module 'stripe' {
  namespace Stripe {
    ...
    interface SetupIntent {
       ...
       *
       * Use `on_session` if you intend to only reuse the payment method when the customer is in your payment flow. Use `off_session` if your customer may or may not be in your payment flow. If not provided, this value defaults to `off_session`.
       */
      usage: string;
    }
