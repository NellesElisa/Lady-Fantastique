  ...
  namespace Stripe {
    ...
    namespace PaymentIntent {
      ...
      namespace PaymentMethodOptions {
        ...
        interface Klarna {
          /**
           * Preferred locale of the Klarna payment page that the customer is redirected to.
           */
    ...
    interface PaymentIntentCreateParams {
      ...
      /**
       * Set to `true` to indicate that the customer is not in your payment flow during this payment attempt, and therefore is unable to authenticate. This parameter is intended for scenarios where you collect card details and [charge them later](https://stripe.com/docs/payments/cards/charging-saved-cards). This parameter can only be used with [`confirm=true`](https://stripe.com/docs/api/payment_intents/create#create_payment_intent-confirm).
       */
    ...
    interface PaymentIntentConfirmParams {
      ...
      /**
       * Set to `true` to indicate that the customer is not in your payment flow during this payment attempt, and therefore is unable to authenticate. This parameter is intended for scenarios where you collect card details and [charge them later](https://stripe.com/docs/payments/cards/charging-saved-cards).
       */
