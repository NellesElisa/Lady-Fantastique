    ...
    namespace Checkout {
      ...
      namespace Session {
        ...
        interface CustomerDetails {
          /**
           * The email associated with the Customer, if one exists, on the Checkout Session at the time of payment or at time of session expiry.
           * Otherwise, if the customer has consented to promotional content, this value is the most recent valid email provided by the customer on the Checkout form.
           */
          email: string | null;

          /**
           * The customer's phone number at the time of payment
           */
          phone: string | null;

          /**
           * The customer's tax exempt status at time of payment.
           */
          tax_exempt: CustomerDetails.TaxExempt | null;

          /**
           * The customer's tax IDs at time of payment.
           */
